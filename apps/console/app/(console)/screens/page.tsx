...
// Real content is Story 2.1's job — this story only builds a thin route so
...
export default async function ScreensPage() {
  ...
  return <h1 className="type-display text-foreground">{format(locale, 'shell.nav.screens')}</h1>;
}
